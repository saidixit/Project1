        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img class="first-slide home-image" src="<c:url value="/resources/images/back1.png" />" alt="First slide">width="400px" height="450px">
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>Welcome to GameCart</h1>
                            <p>Here you can browse and buy Games and Consoles</p>
                        </div>
                    </div>
                </div>
                <div class="item">
